...
- Currently learning [Typescript](https://www.typescriptlang.org/), [Node.js](https://nodejs.dev/) and [NestJS](https://nestjs.com/). Interested in [Hanami](https://hanamirb.org/), [Crystal](https://crystal-lang.org) and [Rust](https://rust-lang.org).
